        ...
        self.add_fields(
            {
                "Configuration": [
                    FieldConfig(
                        ...
                        value=self.form.field_value("target"),
                    ...
                    FieldConfig(
                        ...
                        value=self.form.field_value("water_elevation_parameter"),
                    ...
                    FieldConfig(
                        ...
                        value=self.form.field_value("turbine_elevation"),
                        default_value=0,
                    ...
                    FieldConfig(
                        ...
                        value=self.form.field_value("efficiency"),
                        default_value=1,
                    ...
                    FieldConfig(
                        ...
                        value=self.form.field_value("density"),
                        default_value=1000,
                ...
                "Unit conversion factors": [
                    FieldConfig(
                        ...
                        field_type=FloatWidget,
                        field_args={"min_value": 0},
                        value=self.form.field_value("flow_unit_conversion"),
                        default_value=1,
                        ...
                        "head. See the equation in the Pywr manual for more "
                        "information",
                    ),
                    FieldConfig(
                        ...
                        field_type=FloatWidget,
                        field_args={"min_value": 0},
                        value=self.form.field_value("energy_unit_conversion "),
                ...
                "Bounds": [
                    FieldConfig(
                        ...
                        # optional field
                        field_args={"is_mandatory": False},
                        value=self.form.field_value("max_flow"),
                    ...
                    FieldConfig(
                        ...
                        # optional field
                        field_args={"is_mandatory": False},
                        value=self.form.field_value("min_flow"),
                    ...
                    FieldConfig(
                        ...
                        field_args={"min_value": 0},
                        default_value=0,
                        value=self.form.field_value("min_head"),
