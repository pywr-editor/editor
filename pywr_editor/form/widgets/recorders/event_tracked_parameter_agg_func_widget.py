...
"""
 ...
 used to aggregated the tracked parameter values in
 the EventRecorder.
"""


class EventTrackedParameterAggFuncWidget(AbstractStringComboBoxWidget):
    ...
    def __init__(
        ...
        :param value: A dictionary containing the "event_agg_func" and "agg_func"
        keys with the selected values for the tracked parameter aggregation and
        scenario aggregation.
        :param parent: The parent widget.
        """
        labels_map = {
            # field is optional and can be disabled
        ...
        if value["event_agg_func"] is not None:
            selected_value = value["event_agg_func"]
