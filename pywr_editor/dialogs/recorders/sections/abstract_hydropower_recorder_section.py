...
class AbstractHydropowerRecorderSection(AbstractRecorderSection):
    def __init__(
        self, form: RecorderDialogForm, section_data: dict, node_help_text: str
    ):
        """
        ...
        fields = [
            ...
            FieldConfig(
                ...
                value=form.field_value("water_elevation_parameter"),
            ...
            FieldConfig(
                ...
                value=form.field_value("turbine_elevation"),
                default_value=0,
            ...
            FieldConfig(
                ...
                value=form.field_value("efficiency"),
                default_value=1,
            ...
            FieldConfig(
                ...
                value=form.field_value("density"),
                default_value=1000,
        ...
        additional_sections = {
            "Unit conversion factors": [
                FieldConfig(
                    ...
                    field_type=FloatWidget,
                    field_args={"min_value": 0},
                    value=form.field_value("flow_unit_conversion"),
                    default_value=1,
                ...
                FieldConfig(
                    ...
                    field_type=FloatWidget,
                    field_args={"min_value": 0},
                    value=form.field_value("energy_unit_conversion "),
