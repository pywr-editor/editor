...
class Settings:
    ...
    def save_window_attributes(self, window):
        """
    ...
    def restore_window_attributes(self, window):
        """
    ...
    def save_schematic_lock(self, lock):
        """
    ...
    def save_hide_labels(self, hide):
        """
    ...
    @property
    def are_edge_arrows_hidden(self):
        """
    ...
    def save_hide_arrows(self, hide):
        """
    ...
    def save_schematic_center(self, position):
        """
        Stores the schematic zoom level.
    ...
    def save_recent_file(self, file):
        """
    ...
    def str_to_bool(value):
        """
        Converts a string to boolean. QSettings stores python boolean as lowercase strings.
